...
return (true);
    ...
    <?php  
      ...
      while ($user_data = $res1->fetch_assoc()) {
        ...
        echo "<td><center><a href='edit.php?id=$user_data[id]'>Edit</a>
         | <a href='delete.php?id=$user_data[id]'>Delete</a> | 
         <a href='cetak.php?id=$user_data[id]'>Cetak</a></center></td>";
        echo "<td><center> <input type='checkbox' name='' value=''></center></td>"; ?>
        </tr>
        <?php 
